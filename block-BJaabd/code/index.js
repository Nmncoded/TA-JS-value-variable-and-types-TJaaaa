...
// switch(age){
//   case age< 56 : alert(`You can participate in the marathon`);break;
//   case age< 12 : alert(` You are too young to participate in the marathon`);break;
//   case age< 5 : alert(` Hey Kiddo! Can You Walk ?`);break;
//   case age>55 : alert(` You are too old to participate in the marthon`);break;
...
*/
// [Your code goes here]
let max = +prompt(`the sum of first n natural numbers`);
...
alert(`The sum of first ${max} natural numbers is ${sum}`)
...
let marks = +prompt(`type marks (0-100)`)
switch(true){
...
if(numA>numB){
  alert(`numA is greater than numB`)
}else{
  alert(`numB is greater than numA`)
}
...
switch(operation){
  case "Add" : alert(num1+num2);
  break;
  case "Sub" : alert(num1-num2);
  break;
  case "Mul" : alert(num1*num2);
  break;
  case "Div" : alert(num1/num2);
  break;
  default : alert(`enter a valid input!`)
}